...
permalink: /about/
---
This site is designed for a programmers and technical persons who are considering or are working on programs that will read and write the current version of GEDCOM. Navigate to **Specifications** to review past and current version. **Tools** will provide actual code that is helpful for development.  **Guides** provides helpful technical information and best practices.  **Community** has links to current issues, discussions, blog, and groups to join.
