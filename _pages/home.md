...
feature_row:
  ...
  - image_path: mm-public-feature1.png
    ...
    excerpt: "Join the public repositories for the GEDCOM 7 File Specification and the webpages on GEDCOM.io.   Contribute with issues, pull requests, and comments. Copy, review, and use the published specification for programming whatever genealogical software you want.  Make pull request for changes to these web pages.
