...
descriptions:
  ...
  - A description of the relevant part of a source to support the
    superstructure’s data. See SOURCE_CITATION for more.
  - |
    ...
    substructure. The PAGE is defined to express a “specific location within
    the information referenced;” with a voidPtr there is no information
    referenced, so the PAGE may describe the entire source.
