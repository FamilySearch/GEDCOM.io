...
specification:
  ...
  - |
    ...
    https://gedcom.io/terms/v7/enumset-RESN signifying access to information
    may be denied or otherwise restricted.
    ...
    removal must abide by some constraints: see Removing data for more.
