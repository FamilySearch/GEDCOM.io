...
-   <table><tbody>
    ...
    A list (in no particular order) of enumeration sets that are known to contain this concept as an enumeration value if the enumeration value is permitted in all structures that use the enumeration set, or if this concept is only valid in a subset of structures that use the enumeration set, then a list of structures that are known to permit this concept as a payload.
